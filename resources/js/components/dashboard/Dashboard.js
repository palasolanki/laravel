...
class Dashboard extends Component {
    ...
    setMonthlyIncomeChart(url) {
        api.post("/monthlyIncomeChart", { chart_range: url }).then(res => {
            this.setState({
    ...
    setMonthlyExpenseChart(url) {
        api.post("/monthlyExpenseChart", { chart_range: url }).then(res => {
            this.setState({
            ...
            <Fragment>
                <div className="form-group d-flex align-items-center pl-4 mt-3">
                    ...
                    <select
                        ...
                        className="form-control col-xl-2 col-md-3"
                        style={{ margin: 20 }}
                ...
                <div className="d-flex">
                    <div className="col-xl-6">
                        {this.state.expenseChartData.length > 0 &&
                            this.state.expenseLabels.length > 0 && (
                                <ChartExpense
                                    expesedata={this.state.expenseChartData}
                                    labels={this.state.expenseLabels}
                                />
                            )}
                    </div>
                    <div className="col-xl-6 d-flex flex-column mt-5">
                        <div className="text-bolder">
                            ...
                            {new Intl.NumberFormat("en", {
                                ...
                                expenseTotal /
                                    this.state.expenseChartData.length
                            )}
                        </div>
                ...
                <div className="d-flex">
                    <div className="col-xl-6 mt-md-5 mt-3">
                        {this.state.incomeChartData.length > 0 &&
                            this.state.incomeLabels.length > 0 && (
                                <ChartIncome
                                    incomedata={this.state.incomeChartData}
                                    labels={this.state.incomeLabels}
                                />
                            )}
                    </div>
                    <div className="flex flex-column col-xl-6 mt-md-5 mt-3">
                        <div className="text-bolder mt-5">
                            ...
                            {new Intl.NumberFormat("en", {
                                ...
                                incomeTotal / this.state.incomeChartData.length
                            )}
                        </div>
                        <div className="text-bolder">
                            Total:{" "}
