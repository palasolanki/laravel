                    ...
                    <div className="modal-body">
                        ...
                        >
                            <div className="form-group">
                                ...
                                <input type="text" className="form-control" id="tag" placeholder="Enter Tag" name="tag" value={tag.tag} onChange={handleInputChange} />
                            </div>
                            <div className="form-group">
                                <label>Type:</label>
                                <select className="form-control" id="type" name="type" onChange={handleInputChange} value={tag.type}>
